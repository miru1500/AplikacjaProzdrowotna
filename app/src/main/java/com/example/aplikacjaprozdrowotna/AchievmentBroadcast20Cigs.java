...
public class AchievmentBroadcast20Cigs extends BroadcastReceiver{

    @Override
    public void onReceive(Context context, Intent intent) {
        NotificationCompat.Builder builder = new NotificationCompat.Builder(context, "notifyTest")
                .setSmallIcon(R.drawable.happy)
                .setContentTitle("To już bez 20 papierosa!")
                .setContentText("Brawo, nie spaliłeś już 20 papierosów! Tak trzymaj!")
